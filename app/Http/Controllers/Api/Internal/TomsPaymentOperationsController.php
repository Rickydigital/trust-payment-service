...
class TomsPaymentOperationsController extends Controller
{
    ...
    private function payoutRow(PayoutJob $payout): array
    {
        return [
            ...
            'requested_amount' => (float) ($payout->requested_amount ?? $payout->amount),
            'payout_fee_percent' => (float) $payout->payout_fee_percent,
            'payout_fee_amount' => (float) $payout->payout_fee_amount,
